module.exports = {
    ...
    run: async (client, interaction, container) => {
        ...
        if (requestType === "add-bot") msg = `${interaction.author.tag} (${interaction.author}) has requested to add bot ${botId} (<@${botId}>) to this server.`;
        else msg = `${interaction.author.tag} (${interaction.author}) has requested to remove bot ${botId} (<@${botId}>) from this server.`;
